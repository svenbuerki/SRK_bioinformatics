...
1. **What is the S-allele richness of the species?** The species-level allele pool approximates the balancing selection richness equilibrium and serves as the reference baseline against which population-level deficits are measured.
