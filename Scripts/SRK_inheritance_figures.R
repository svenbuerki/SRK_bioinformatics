...
TRAJ <- "Tables/SRK_inheritance_trajectories.tsv"
TTSC <- "Tables/SRK_inheritance_time_to_sc.tsv"
...
ggsave("figures/SRK_inheritance_pNULL_trajectories.png",
...
ggsave("figures/SRK_inheritance_SC_progression.png",
...
ggsave("figures/SRK_inheritance_time_to_sc.png",
