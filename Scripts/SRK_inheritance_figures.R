...
TRAJ <- "Tables/Phase4/step24_inheritance_trajectories.tsv"
TTSC <- "Tables/Phase4/step24_inheritance_time_to_sc.tsv"
...
ggsave("figures/Phase4/step24_inheritance_pNULL_trajectories.png",
...
ggsave("figures/Phase4/step24_inheritance_SC_progression.png",
...
ggsave("figures/Phase4/step24_inheritance_time_to_sc.png",
