...
dat <- read_tsv("Tables/SRK_EO_allele_richness_with_nulls.tsv",
...
# Full figure
ggsave("figures/SRK_P_compat_traffic_light_EO_with_nulls.png", plot = p_full,
       width = 10, height = 5.5, dpi = 200)
ggsave("figures/SRK_P_compat_traffic_light_EO_with_nulls.pdf", plot = p_full,
       width = 10, height = 5.5)

# Blank figure (zones + threshold lines + EO labels + BL strip; no data)
ggsave("figures/SRK_P_compat_traffic_light_EO_with_nulls_blank.png", plot = p_blank,
       width = 10, height = 5.5, dpi = 200)
ggsave("figures/SRK_P_compat_traffic_light_EO_with_nulls_blank.pdf", plot = p_blank,
       width = 10, height = 5.5)
