...
# 1. Load files
############################
geno <- read.table("Tables/SRK_individual_allele_genotypes_with_nulls.tsv",
                   header = TRUE, sep = "\t", check.names = FALSE,
                   stringsAsFactors = FALSE)
zyg  <- read.table("Tables/SRK_individual_zygosity_with_nulls.tsv",
                   header = TRUE, sep = "\t",
                   stringsAsFactors = FALSE)
...
write.table(eo_results, "SRK_population_genetic_summary_with_nulls.tsv",
...
write.table(bl_results, "SRK_population_genetic_summary_BL_with_nulls.tsv",
            sep = "\t", quote = FALSE, row.names = FALSE)
...
pdf("SRK_population_genetic_summary_with_nulls.pdf", width = 14, height = 9)
