#!/usr/bin/env Rscript
# =============================================================================
# SRK_P_compat_traffic_light.R — stakeholder-facing figure
...
#
# Outputs:
#   figures/SRK_P_compat_traffic_light_EO.png
#   figures/SRK_P_compat_traffic_light_EO.pdf
# =============================================================================
...
cat("\nWritten:\n")
cat("  figures/SRK_P_compat_traffic_light_EO.png\n")
cat("  figures/SRK_P_compat_traffic_light_EO.pdf\n")
cat("  figures/SRK_P_compat_traffic_light_EO_blank.png\n")
cat("  figures/SRK_P_compat_traffic_light_EO_blank.pdf\n")
